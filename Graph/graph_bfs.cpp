...
class Graph
{
    public:
        ...
        void addEdge(int src, int dest)
        {
         ...
         // directed
            ...
            Node * n = new Node;  //newNode stores both data(dest) and *next pointer
            n->data = dest;					//consider src = 0 and dest = 1		0<----->1 for undirected graph
            n->next = NULL;
    ...
    while(!Q.empty()){
        ...
        void printGraph()
        {
            ...
            for (i = 0; i < v; ++i)
            {
                Node* tmp = a[i].head;		//tmp has the address of (0,1..)vertex head
